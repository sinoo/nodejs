...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement("input", {type: "button", onClick: this._clickHandler, value: "点我"})
	      )
	    );
	  },
	...
	var SubComponent = React.createClass({displayName: "SubComponent",
	  render: function() {
	    return React.createElement("div", {id: "sub"}, React.createElement("span", null, "I'm about to disappear."));
	  },
	});

	ReactDOM.render(React.createElement(Component, null), document.getElementById('container1'));
	ReactDOM.render(React.createElement(SubComponent, null), document.getElementById('container2'));
